            ...
            <div className='column1'>
              <div className='leftSide'>
                <div className='textContainer'>
                  ...
                  <br />
                  <p>-Vad ska vi ta oss till nu? sa Lilly Manet förtvivlat. Just då gav sig den inspärrade maneten till ett tjut av rädsla.</p>
                  <br />
                  ...
                  <br />
                  <p>-Kantor, du är bra på att räkna. Så när du räknar till 3 ska Lilly Manet som är bra på att brännas ställa sig ovanför muränan och bränna honom så hårt som möjligt så att han simmar ut från hålet. Då kommer Deffy Delfin som är snabb att reta muränan så att han börjar jaga Deffy. Medan muränan jagar Deffy kommer vi hinna gå in och hämta Gregor Manet.</p>
                  <br />
                  <p>-Vad händer om han får tag i mig? frågade Deffy Delfin oroligt. </p>
                  <p>-Det kommer han inte göra, du är så snabb att han tillslut inte kommer att orka hänga med i din takt, sa Kantor Bläckfisk.</p>
