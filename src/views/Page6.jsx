            ...
            <div className='column1'>
              <div className='leftSide'>
                <div className='textContainer'>
                  ...
                  <br />
                  <p>Kantor Bläckfisk simmade över mållinjen och hurrade att han vann. Då tog Anho till orda. -Jag är domare och jag bestämmer att du inte vann.</p>
                  <p>-Varför då? suckade Kantor Bläckfisk.</p>
                  <p>-För att du knuffade Deffy Delfin så att hon ramlade.</p>
                  <p> -Okej, okej du har rätt Anoh, förlåt Deffy, sa Kantor Bläckfisk skamset.</p>
                  <br />
