            ...
            <div className='column1'>
              <div className='leftSide'>
                <div className='textContainer'>
                  ...
                  <br />
                  <p>Gregor Manet såg lite skamsen ut och viskade. -Förlåt att jag att jag har varit elak mot dig. Du är en riktigt brännmanet och det är häftigt att du kan lysa istället för att brännas. Lilly Manet höll med. </p>
